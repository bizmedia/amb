...
- Epics и sprints в этом документе не детализируются; см. отдельный PRD
...
|------|--------|-----------|
| 2026-03-26 | 1.1 | Issue keys, epics и sprints вынесены в отдельный PRD; scope базового tasks-модуля уточнён |
